...
// becuase when we click it will rerender component and the refernce of variable will agian get set and fucntion will be declare
...
// tough console will output 20 but k inside div will not update so state management is different in reactjs